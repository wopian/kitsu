<h1 align=center>Kitsu Core Node</h1>

<p align=center>
  <a href=https://www.npmjs.com/package/kitsu-core-node><img alt=npm src=https://flat.badgen.net/npm/v/kitsu-core-node></a>
  <a href=https://www.npmjs.com/package/kitsu-core-node><img alt=npm src=https://flat.badgen.net/npm/dt/kitsu-core-node></a>
  <a href="https://bundlephobia.com/result?p=kitsu-core-node"><img alt=bundlephobia src=https://flat.badgen.net/bundlephobia/minzip/kitsu-core-node></a>
  <a href="https://david-dm.org/wopian/kitsu?path=packages/kitsu-core-node"><img alt=deps src="https://flat.badgen.net/david/dep/wopian/kitsu/packages/kitsu-core-node"></a>
</p>
...
<p align=center>
  ...
  <a href="https://packagephobia.now.sh/result?p=kitsu-core-node"><img alt=packagephobia src=https://flat.badgen.net/packagephobia/install/kitsu-core-node></a>
...
```bash
yarn add kitsu-core-node
npm install kitsu-core-node
```

```js
import { camel } from 'kitsu-core-node'      // ES Modules and Babel
const { camel } = require('kitsu-core-node') // CommonJS and Browserify
...
```html
<script src='https://bundle.run/kitsu-core-node@7?name=kitsuCore'></script>
```
