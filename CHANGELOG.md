...
* **release:** update documentation ([6201aa4](https://github.com/wopian/kitsu/commit/6201aa4))


### Documentation Changes

* **kitsu-core:** fix typo in CDN script example ([6ca6f62](https://github.com/wopian/kitsu/commit/6ca6f62))
...
* **release:** update documentation ([ec5f653](https://github.com/wopian/kitsu/commit/ec5f653))


### Documentation Changes

* **kitsu-core:** update README ([61ee773](https://github.com/wopian/kitsu/commit/61ee773))
...
* **release:** update documentation ([ea8790a](https://github.com/wopian/kitsu/commit/ea8790a))
* cleanup configs ([4576fd5](https://github.com/wopian/kitsu/commit/4576fd5))


### Documentation Changes

* add migration for `kitsu/node` and `kitsu-core/node`  users ([4bd2182](https://github.com/wopian/kitsu/commit/4bd2182))


### New Features

* **kitsu:** remove redundent node folder ([ec9bc8d](https://github.com/wopian/kitsu/commit/ec9bc8d))
* **kitsu-core:** create browser bundle (umd) ([ca01db8](https://github.com/wopian/kitsu/commit/ca01db8))
* **kitsu-core:** proper tree-shaking for individual components ([b2c55a0](https://github.com/wopian/kitsu/commit/b2c55a0))
* **kitsu-core:** remove redundent node folder ([4041649](https://github.com/wopian/kitsu/commit/4041649))
